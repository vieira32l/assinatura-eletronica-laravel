    ...
    public function createPDF(Request $request)
    {
        ...
        */
        ...
        if (openssl_pkcs12_read($data, $certs, $request->password)) {
            ...
            //debug do conteúdo do certificado
            ...
            // testa se o registro do certificado é de teste 
            if (isset($info[1])) {
                ...
                // adiciona um registro aleatório para exibição de teste apenas
                $cnpj = rand(10000000000000, 99999999999999);
                $type = 'CNPJ: ' . preg_replace("/(\d{2})(\d{3})(\d{3})(\d{4})(\d{2})/", "\$1.\$2.\$3/\$4-\$5", $cnpj);
            }
        ...
        */
        ...
        $pdf = new TCPDF('L', 'mm', 'P', true, 'UTF-8', false);
        ...
        // setando informações do documento
        $pdf->SetCreator(PDF_CREATOR);
        $pdf->SetAuthor('FUSION DMS');
        $pdf->SetTitle('PROTÓTIPO DE ASSINATURA DIGITAL');
        $pdf->SetSubject('PROTÓTIPO DE ASSINATURA');
        $pdf->SetKeywords('assinatura, PDF, exemplo, teste, guia');
